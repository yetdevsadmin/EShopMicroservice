    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            ...
            var order1 = Order.Create(
                            ...
                            payment1);
            order1.AddOrderItem(ProductId.of(new Guid("d2d0b1b1-1b1b-1b1b-1b1b-1b1b1b1b1b1c")), 2, 500);
            order1.AddOrderItem(ProductId.of(new Guid("d2d0b1b1-1b1b-1b1b-1b1b-1b1b1b1b1b2d")), 1, 400);
            ...
            var order2 = Order.Create(
                            ...
                            payment2);
            order2.AddOrderItem(ProductId.of(new Guid("d2d0b1b1-1b1b-1b1b-1b1b-1b1b1b1b1b1e")), 1, 650);
            order2.AddOrderItem(ProductId.of(new Guid("d2d0b1b1-1b1b-1b1b-1b1b-1b1b1b1b1b2f")), 2, 450);
